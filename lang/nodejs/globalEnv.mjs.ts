...
import * as sesshim from './sesshim';
...
globalEnv.makePromise = harden((executor: (resolve: (value?: {} | PromiseLike<{}>) => void, reject: (reason?: any) => void) => void) => harden(new Promise(executor)));
