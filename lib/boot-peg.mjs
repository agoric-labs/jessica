...
function bootPeg(makePeg, bootPegAst) {
    ...
    function quasiMemo(quasiCurry) {
        ...
        let debug = false;
        const templateTag = (templateOrDebug, ...subs) => {
    ...
    function metaCompile(baseRules) {
        ...
        return function parserTag(...baseActions) {
            ...
            const _asExtending = (baseQuasiParser) => {
                ...
                const pegTag = quasifyParser(parserCreator);
            ...
            quasiParser.extends = (baseQuasiParser) => (template, ...subs) => quasiParser(template, ...subs)._asExtending(baseQuasiParser);
            return quasiParser;
        };
    }
