...
const ACCEPT = immunize((self, pos) => {
...
const lHexDigits = immunize('0123456789abcdef');
const uHexDigits = immunize('ABCDEF');
...
const bootPeg = immunize((makePeg, bootPegAst) => {
    ...
    function metaCompile(baseRules) {
        ...
        return function parserTag(...baseActions) {
            ...
            const closedDefaultBaseGrammar = defaultBaseGrammar;
...
export default immunize(bootPeg);
