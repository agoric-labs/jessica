...
function makeJessie(peg, justinPeg) {
    ...
    / pureAssignExpr;
    moduleDeclaration <-
      declOp moduleBinding ** COMMA                    ${(op, decls) => [op, decls]}
    / functionDecl;
...
//# sourceMappingURL=quasi-jessie.mjs.js.map