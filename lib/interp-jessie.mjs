...
function makeInterpJessie(computedGet) {
    ...
    const moduleActions = makeMap([
        ['module', evalModule],
    ]);
    const moduleBodyActions = makeMap([
        ['functionDecl', evalFunctionDecl],
    ]);
    const exprActions = makeMap([
        ['call', evalCall],
        ['data', evalData],
        ['get', evalGet],
        ['use', evalUse],
    ]);
    const statementActions = makeMap([
        ...exprActions.entries(),
        ['functionDecl', evalFunctionDecl],
        ['block', evalBlock],
    ]);
