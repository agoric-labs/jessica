...
function bootEnv(endowments) {
    // Bootstrap a peg tag.
    const {metaCompile, pegExtractorTag, pegTag: bootPegTag} = bootPeg(makePeg, bootPegAst);
    ...
    const {defs: reparsedPegAst} = makePeg(pegExtractorTag, (ast) => ast);
...
`;
    ...
    // The finalised peg tag is made from the pegTag and our metaCompile
    // function.
