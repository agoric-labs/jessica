...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"rKWM":[function(require,module,exports) {
var define;
...
function getSharedGlobalDescs(unsafeGlobal) {
  ...
  describe(stableGlobalPropertyNames, false, false, false); // These we keep replaceable and removable, because we expect
...
function createSafeEvaluatorFactory(unsafeRec, safeGlobal, transforms, sloppyGlobals) {
  ...
  function factory(endowments = {}, options = {}) {
    ...
    function safeEvalOperation(src) {
      ...
      rewriterState = applyTransforms(rewriterState, allTransforms); // Combine all optimizable globals.
...
You probably want a Compartment instead, like:
  const c = s.global.Realm.makeCompartment({ sloppyGlobals: true })`);
    ...
    const namedIntrinsics = r.evaluate(`(${getNamedIntrinsics})`)(r.global, whitelist); // Gather the intrinsics only.
    ...
    r.evaluate(`(${repairDataProperties})`)(allIntrinsics, repairPlan); // Finally freeze all the primordials, and the global object. This must
...
},{"@agoric/make-hardener":"rKWM","vm":"boWn"}],"nUr5":[function(require,module,exports) {
"use strict";
